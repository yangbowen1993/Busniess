...
public class ColorKucunResult {
    ...
    public static void wrtie() throws IOException {
        //读裁片
        ...
        head.createCell(1).setCellValue("裁片颜色");
        head.createCell(2).setCellValue("秦丝颜色");
        head.createCell(3).setCellValue("裁片数量");
        head.createCell(4).setCellValue("销售数量");
        head.createCell(5).setCellValue("剩余数量");
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            rowData.createCell(3).setCellValue(caipianColorInfo.num);
            ...
            for (int j = 0; j < xiaoshouList.size(); j++) {
                ...
                if (value != null && value.equals(xiaoshouColorInfo.kuanhao + "-" + xiaoshouColorInfo.color)) {
                    rowData.createCell(2).setCellValue(xiaoshouColorInfo.color);
                    rowData.createCell(4).setCellValue(xiaoshouColorInfo.num);
                    tempXiaoshou += xiaoshouColorInfo.num;
                    rowData.createCell(5).setCellValue(caipianColorInfo.num - xiaoshouColorInfo.num);
                    break;
                }
            }
            ...
            if (i + 1 >= dataList.size() || !dataList.get(i + 1).kuanhao.equals(tempkuanhao)) {
                ...
                rowData2.createCell(2).setCellValue("总数");
                rowData2.createCell(3).setCellValue(tempCaipian);
                rowData2.createCell(4).setCellValue(tempXiaoshou);
                rowData2.createCell(5).setCellValue(tempCaipian - tempXiaoshou);
                if(tempkuanhao.endsWith("180")||tempkuanhao.endsWith("038")||tempkuanhao.endsWith("310")||tempkuanhao.endsWith("335")){
                    rowData2.createCell(7).setCellValue(tempCaipian - tempXiaoshou);
                }else if(tempkuanhao.endsWith("062")||tempkuanhao.endsWith("265")||tempkuanhao.endsWith("278")||tempkuanhao.endsWith("329")){
                    rowData2.createCell(8).setCellValue(tempCaipian - tempXiaoshou);
                }
                else {
                    rowData2.createCell(6).setCellValue(tempCaipian - tempXiaoshou);
                }
